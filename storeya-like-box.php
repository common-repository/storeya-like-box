...
function slb_insert()
{
    ...
    if (get_option('slbID')) {
	    ...
	    $sty_script = "<script>(function(e){ var t = e.createElement(\"script\"); t.src = \"//www.storeya.com/externalscript/storeyaall?sid=".htmlspecialchars($secret_key)."\"; t.type = \"text/javascript\"; t.async = true;e.getElementsByTagName(\"head\")[0].appendChild(t)})(document)</script>";
...
?></span></h3>
            ...
            _e('Convert your visitors to paying customers with StoreYa!', $slb_domain);
?>"><img src="<?php
            echo (plugins_url( 'storeya-like-box.jpg', __FILE__ ));
?>" height="200" width="200" alt="<?php
            _e('StoreYa Logo', $slb_domain);
?>" /></a></p>
